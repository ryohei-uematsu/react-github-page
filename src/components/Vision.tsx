  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        <p className="text-lg text-text-light mb-16 mt-8">私たちが大切にしていること</p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="text-lg md:text-xl leading-loose text-text-dark space-y-4">
            <p>世の中が変化している中で、会社という組織のあり方も変化が必要と考えています。</p>
            <p>
          ...
          <div className="bg-white p-8 md:p-12 rounded-2xl shadow-xl">
            <h3 className="text-2xl md:text-3xl mb-6 text-primary font-bold">HIGHFLATの約束</h3>
